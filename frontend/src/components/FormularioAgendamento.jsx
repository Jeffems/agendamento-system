...
export default function FormularioAgendamento({
  ...
  const handleSubmit = (e) => {
    ...
    // Convertemos para ISO UTC (com Z) antes de salvar
    const dt = new Date(dados.data_agendamento);
    if (Number.isNaN(dt.getTime())) {
      // mantém o comportamento simples: impede salvar com data inválida
      // (se quiser, dá pra mostrar um toast/alert aqui)
      return;
    }
