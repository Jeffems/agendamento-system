  ...
  return (
    <div className="min-h-screen bg-slate-950 lg:grid lg:grid-cols-[1.05fr_.95fr]">
      <section className="relative hidden overflow-hidden p-12 lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative flex items-center gap-3 text-white"><span className="grid h-11 w-11 place-items-center rounded-xl bg-indigo-500"><CalendarCheck2 className="h-6 w-6" /></span><div><p className="text-lg font-bold">AgendaPro</p><p className="text-xs text-slate-400">Gestão de horários</p></div></div>
        ...
        <p className="relative text-xs text-slate-500">AgendaPro · Plataforma segura de agendamentos</p>
      </section>
      <main className="flex min-h-screen items-center justify-center bg-[#f6f7fb] p-5 sm:p-10">
        <div className="w-full max-w-md">
          <div className="mb-8 flex items-center gap-3 lg:hidden"><span className="grid h-11 w-11 place-items-center rounded-xl bg-indigo-600 text-white"><CalendarCheck2 className="h-6 w-6" /></span><span className="text-xl font-bold">AgendaPro</span></div>
